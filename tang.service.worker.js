...
const CACHE_NAME = "tang-cache";
const OFFLINE_URL = "tang.offline.html";
// Files that will be cached on load.
const CACHED_FILES = ["tang.html","tang.js","tang.wasm","tang.pck","tang.offline.html","tang.icon.png","tang.apple-touch-icon.png"];
